...
// el-drawer 的 v-model：关闭（遮罩点击/Esc）时向父级抛出 close
...
.menu-list { flex: 1; min-height: 0; overflow-y: auto; padding: 8px 0; }
.menu-item {
  display: flex; align-items: center; gap: 12px;
...
<style>
/* el-drawer 面板渲染在 body 下，scoped 样式无法命中其内部，用全局类兜底 */
.side-menu-drawer .el-drawer__body {
  padding: 0;
  display: flex;
